...
query_expansion = [2]
rerank = [True]  # , "rrf", False]  # True, "rrf", False
...
def pipe_parameter_run(parameters, n_slice_rag_elements, write_to_dir):
    ...
    contexts_ids = pipe.rag_elements[0]["contexts_ids"]
    print(f"context expansion: {prepost_context_val}")
    print(contexts_ids)
...
n_worker = 1
n_slice_rag_elements = 1
write_to_dir = "./parallel_test_dir/"
